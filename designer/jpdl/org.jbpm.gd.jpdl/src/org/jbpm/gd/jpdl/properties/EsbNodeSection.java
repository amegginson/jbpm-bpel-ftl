...
public class EsbNodeSection extends AbstractPropertySection {
	...
	private FormData createEsbInfoAreaLayoutData() {
 	...
 	public void setInput(IWorkbenchPart part, ISelection selection) {
        ...
        if (input instanceof EsbNode) {
        	esbNode = (EsbNode)input;
        	refresh();
        }
    }
 	
 	public void refresh() {
 		esbConfigurationComposite.setEsbNode(esbNode);
     }
